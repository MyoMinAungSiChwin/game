							...
							<view style="display: flex;justify-content: space-between;align-items: center;">
								<view style="margin:20rpx;">
									<view
										...
										{{dataList.agent_name == '无上级代理' ? $t('team.text60') : dataList.agent_name || ''}}
									</view>
								</view>
								<view style="display: flex;align-items: center;" v-if="filters.username">
								...
								<view class="my-withdraw-cards">
									<view class="my-ew-banks-wrap">
										<view class="withdraw-bank-card-ew">
											<view class="cards-title" style="margin-left: 30rpx;">{{dataList.username || ''}}</view>
											<view class="card">
												<!-- 每行作为一个 flex 容器 -->
												<view class="row">
													<view class="item">
														<text class="label">{{$t('team.text10')}}：</text>
														<text class="value">{{dataList.total_deposit || 0}}</text>
													</view>
													<view class="item">
														<text class="label">{{$t('team.text11')}}：</text>
														<text class="value">{{dataList.total_withdraw || 0}}</text>
													</view>
												</view>
												...
												<view class="row">
													...
													<view class="item">
														...
														<text class="value"
															style="color: blue;">{{dataList.yxtz_count || 0}}</text>
													</view>
													<view class="item">
												...
												<view class="row">
													...
													<view class="item">
														...
														<text class="value"
															style="color: red;">{{dataList.tdyk_count || 0}}</text>
													</view>
												</view>
