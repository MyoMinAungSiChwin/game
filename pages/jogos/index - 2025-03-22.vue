						...
						<view style="width: 100%; overflow-x: auto;">
							<u-grid :border="false" col="5"
								...
								<u-grid-item v-for="(listItem,listIndex) in gameNavList" :key="listIndex"
									...
									<image :src="listItem.status == navItemStatus ? listItem.currUrl : listItem.url"
										mode="widthFix" width="148rpx" height="148rpx">
		...
		data() {
			return {
				...
				gameNavList: [{
					...
					{
						url: require('@/static/images/jogos/hot.png'),
						currUrl: require('@/static/images/jogos/hot.png'),
						status: 3
					},
					// {
					// 	url: require('@/static/images/jogos/STUD2.png'),
					...
					// },
					{
						url: require('@/static/images/jogos/PG2.png'),
						currUrl: require('@/static/images/jogos/PG2.png'),
						status: 5
					},
					// // {
					...
					// // }, 
					{
						...
						currUrl: require('@/static/images/jogos/pp.png'),
						status: 7
					},
					{
						url: require('@/static/images/jogos/ag.png'),
						currUrl: require('@/static/images/jogos/ag.png'),
						status: 8
					}, {
						url: require('@/static/images/jogos/flash.png'),
						currUrl: require('@/static/images/jogos/flash.png'),
						status: 10
					}
