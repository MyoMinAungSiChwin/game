				...
				<view class="margin_con">
						...
						<view style="width: 100%; overflow-x: auto;">
							<u-grid :border="false" col="7"
								...
								<u-grid-item v-for="(listItem,listIndex) in newGameNavList" :key="listIndex"
									...
									<u-image :src="listIndex == navItemStatus ? listItem.url : listItem.select_url"
					...
					<view style="color: #fff;
						...
						margin:20rpx 0rpx; 
						 ...
						 flex-wrap: wrap;
						 align-items: center;" v-if="!dzpk_show">
						<view class="d_j_nav game_flex d_bgColor"
					...
					<template v-else>
						...
						<view v-if="!dzpk_show">
							<scroll-view :scroll-top="virtualScrollTop" @scroll="handleScroll" :scroll-into-view="365"
