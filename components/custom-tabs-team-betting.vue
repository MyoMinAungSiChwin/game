...
.tab-item {
	...
	padding: 0 20rpx;         /* Smaller padding */
	transition: all 0.3s;
	position: relative;
	width: 35%;              /* Smaller width */
	border: 1rpx solid #ddd; /* Small border */
	border-radius: 10rpx;    /* Slightly rounded corners */
	box-sizing: border-box;
	margin: 20rpx 6rpx;          /* Reduced margin */
...
/* Active tab styling simplified: just text color */
.tab-item.active {
...
.tab-label {
	font-size: 26rpx;       /* Slightly smaller font */
	color: #666;
