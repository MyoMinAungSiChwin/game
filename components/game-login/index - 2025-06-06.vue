 ...
 background: rgba(41, 46, 61, 0.3);
  ...
  ">
					...
					<template v-if="loginNavIndex == 1">
						...
						<view>
							<u--input :placeholder="$t('login.text12')" border="none" v-model="loginForm.account" color="#fff"
								...
								<template slot="prefix">
									<u-icon name="account-fill" color="#999" size="38rpx"></u-icon>
								</template>
							</u--input>
						...
						<view>
							<u--input :placeholder="$t('login.text13')" border="none" v-model="loginForm.password" color="#fff"
								:customStyle="{'background': '#292e3d', height: '80rpx', padding: '0 20rpx', marginTop: '30rpx', border: '1px solid #666'}"
								...
								<template slot="suffix">
									<u-icon name="eye-fill" color="#999" size="38rpx" @tap="isOpen=!isOpen"></u-icon>
								</template>
							</u--input>
					...
					<template v-if="loginNavIndex == 2">
						...
						<view>
							<u--input :placeholder="$t('login.text12')" border="none" v-model="loginForm.username" color="#fff"
								:customStyle="{'background': '#292e3d', height: '80rpx', padding: '0 20rpx', marginTop: '30rpx', border: '1px solid #666'}"
						...
						<view>
							<u--input :placeholder="$t('login.text13')" border="none" v-model="loginForm.password"
								:type="isOpen?'text':'password'" color="#fff"
								:customStyle="{'background': '#292e3d', height: '80rpx', padding: '0 20rpx', marginTop: '30rpx', border: '1px solid #666'}">
								<template slot="prefix">
									<u-icon name="lock-fill" color="#999" size="38rpx"></u-icon>
								</template>
								<template slot="suffix">
									<u-icon @tap="isOpen=!isOpen" name="eye-fill" color="#999" size="38rpx"></u-icon>
								</template>
							</u--input>
							<text class="error_input_text" v-show="passErr">{{passErrText}}</text>
						</view>
						<view>
							<u--input :placeholder="$t('login.text14')" border="none" v-model="loginForm.qrpassword"
								:type="isqrOpen ?'text':'password'" color="#fff"
								:customStyle="{'background': '#292e3d', height: '80rpx', padding: '0 20rpx', marginTop: '30rpx', border: '1px solid #666'}">
								<template slot="prefix">
									<u-icon name="lock-fill" color="#999" size="38rpx"></u-icon>
								</template>
								<template slot="suffix">
									<u-icon @tap="isqrOpen=!isqrOpen" name="eye-fill" color="#999"
										size="38rpx"></u-icon>
								</template>
							</u--input>
						...
						<view>
							<u--input :placeholder="$t('login.text15')" border="none" v-model="loginForm.payeename" color="#fff"
								:customStyle="{'background': '#292e3d', height: '80rpx', padding: '0 20rpx', marginTop: '30rpx', border: '1px solid #666'}">
								<template slot="prefix">
									<u-icon name="account-fill" color="#999" size="38rpx"></u-icon>
								</template>
						...
						<view>
							<u--input :placeholder="$t('login.text16')" border="none" v-model="loginForm.mobile" color="#fff"
								:customStyle="{'background': '#292e3d', height: '80rpx', padding: '0 20rpx', marginTop: '30rpx', border: '1px solid #666'}"
								:class="[mobileErr && 'error_input_border']">
								<template slot="prefix">
									<u-icon name="phone-fill" color="#999" size="38rpx"></u-icon>
								</template>
					...
					<u-button class="login_btn" :style="{
						    backgroundImage: 'url(../static/images/btns.png)',
						    backgroundSize: '100% 100%',
						    backgroundRepeat: 'no-repeat',
							color:'#fff'
						  }" :text="loginNavIndex == 1 ? $t('jogos.text24') : $t('jogos.text25')" shape="circle"
						@click="loginSubmit" :disabled="isSubmitting"></u-button>
					<!-- <view class="login_btn23"  @tap="$u.debounce(loginSubmit, 2500)" >
						<text class="btn_text">
